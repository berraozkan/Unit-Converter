...
int main()
{
    ...
    printf("Temprature(T), Currency(C) and Mass(M)\n");
    ...
    else if (category == 'C')
    {
        ...
        if (currencyChoice == 1)
        {
            ...
            USDtoEURO = userinputUSDtoEuro * 0.91;
            printf("Euro: %.2f", USDtoEURO); // %.2f = rounds the float to only 2 decimal places;
        }
        else if (currencyChoice == 2)
        {
            printf("Please enter the USD amount:\n");
            scanf("%d", &userinputUSDtoTL);
            USDtoTL = userinputUSDtoTL * 19.43;
            printf("TL: %.2f", USDtoTL);
        }
        else if (currencyChoice == 3)
        {
            printf("Please enter the USD amount:\n");
            scanf("%d", &userinputUSDtoJPY);
            USDtoJPY = userinputUSDtoJPY * 133.76;
